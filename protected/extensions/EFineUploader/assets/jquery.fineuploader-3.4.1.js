...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        text: {
            ...
            cancelButton: 'Вiдмiнити завантаження',
            retryButton: 'Спробувати знову',
            deleteButton: 'Видалити файл',
            failUpload: 'Невдале завантаження',
            dragZone: 'Перемiстiть сюди файли для завантаження',
            dropProcessing: 'Опрацювання кинутих файлiв...',
            formatProgress: "{percent}% з {total_size}",
            waitingForResponse: "Опрацювання..."
        },
        ...
        messages: {
            tooManyFilesError: "Ви можите скинути тiльки один файл одночасно"
        },
        retry: {
            showAutoRetryNote: true,
            autoRetryNote: "Ще одна спроба {retryNum}/{maxAuto}...",
            showButton: false
        },
        deleteFile: {
            forceConfirm: false,
            confirmMessage: "Ви впевненi, що хочите видалити файл {filename}?",
            deletingStatusText: "Видаляемо...",
            deletingFailedText: "Невдале видалення"
        ...
        paste: {
            promptForName: false,
            namePromptMessage: "Будьласка, дайте назву зображенню"
        },
        ...
        showPrompt: function(message, defaultValue) {
            ...
            if (retVal != null && qq.trimStr(retVal).length > 0) {
                ...
                promise.failure("Невизначене або невiрне задане значення.");
            }
