...
-->
	<table class="faq-item">
		...
		<tr>
			<th>A:</th>
			<td>
			<p>Наши официальные группы: <a href="http://vk.com/ukryama" title="УкрЯма ВКонтакте" target="_blank" >ВКонтакте</a>, 
		<a href="https://www.facebook.com/ukryama" title="Фейсбук УкрЯмы" target="_blank" >Facebook</a>, 
	<a href="https://twitter.com/#!/ukryama" title="Твиттер УкрЯмы" target="_blank" >Twitter</a>. Пока всё.</p>
			</td>
...
Идеологически, мы похожи, но с учетом украинского законодательства. C 2012 года проекты развиваются независимо.
Поддержкой и развитием УкрЯмы занимается команда добровольцев: Дмитрий Повесьма, Дмитрий Шевцов, 
Григорий Кравцов, Павел Белоусов и другие.
</td>
		</tr>		
	</table>	
	<table class="faq-item">
		<tr>
			<th>Q:</th>
			<td class="question">У вас на сайте есть яма, которую уже заделали. Автор ямы, похоже, забыл про неё. 
Как можно пометить яму, как исправленную, если не я её создал?</td>
		</tr>		
		<tr>
			<th>A:</th>
			<td>Пришлите на <a class="txttohtmllink" href="mailto:info@ukryama.com" title="Написать письмо">info@ukryama.com</a> 
               фотографию исправленного участка, желательно с того же ракурса, что и раньше. Укажите номер дефекта на сайте. 
               Мы отметим факт исправления дефекта вручную.</td>
		</tr>		
	</table>	
</div>