<p>Доброго дня!</p>
<p>Скарга на негаразд на дорозі, відзначений на УкрЯмі, було відправлено та доставлено <?php print (Y::dateFromTime($deliv->ddate))?><strong> 
до <?php print ($request->auth_ua->name)?>. Дякуємо за вашу небайдужість до стану доріг!</strong>
</p>
...
<?php print(Yii::app()->createUrl("payments/add?holeid=".$model->ID)); ?>.  Це підвищить шанси на належний розгляд.</p>
