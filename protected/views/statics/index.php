...
<div class="stats">
	<?php foreach($arResult['geography'][0] as $ar){?>
...
<div class="stats">
<?php foreach($arResult['geography'][1] as $ar){?>
...
<div class="stats">
<?php foreach($arResult['STATE'][0] as $ar){?>
...
<div class="stats">
<?php foreach($arResult['STATE'][1] as $ar){?>
	<?=$ar['time']?><br>
<?php }?>
</div>
-->
...
<div class="stats">
<?php foreach($arResult['user'][0] as $ar){?>
...
<div class="stats">
<?php foreach($arResult['user'][1] as $ar){?>
	<?php echo $ar['user']; ?> &nbsp; &mdash;  <?=$ar['counts']?><br>
<?php }?>
</div>
</div>
