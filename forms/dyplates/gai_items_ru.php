...
<div>
<b><?= $when ?> р.</b>
мною на території дороги за адресою: <b><?= $where ?></b>  були виявлені сторонні предмети, 
що мають відношення до облаштування дорогги та не передбачені Державним стандартом України ДСТУ 3587-97 —
«Автомобільні дороги, вулиці та залізничні переїзди. Вимоги до експлуатаційного стану». 
Повне прибирання на автомобільних дорогах загального користування здійснюється негайно після 
виявлення сміття або сторонніх предметів (крім випадків, віднесених до категорії стихійних лих), і не повинно перевищувати 72 годин. 
Ці недоліки є небезпечними для життя та здоров'я учасників дорожнього руху.<br><br>
...
адміністративного правопорушення, визначеного ч. 1, 3 ст. 140 КУпАП.<br>
Відповідно до ч. 10 ст. 52-1,3 Закону України «Про дорожній рух» та ч. 1 ст. 23 Закону «Про Національну поліцію», поліція
забезпечую безпеку дорожнього руху; здійснює своєчасне реагування на заяви та повідомлення про кримінальні, адміністративні 
правопорушення або події; виявляє
...
<li>Вжити заходів для забезпечення безпечного експлуатаційного стану вказаної ділянки дороги та продовжувати вживати їх аж до усунення 
правопорушення та забезпечення безпечних умов дорожнього руху.</li>
<li>Встановити причину вчинення адміністративного правопорушення та умов, що прзвели до його вчинення.</li>
