...
<div>
<b><?= $when ?> р.</b> 
мною на території дороги за адресою: <b><?= $where ?></b> (на тротуарі) були виявлені недоліки дороги, 
...
<li>Вжити заходів для забезпечення безпечного експлуатційного стану вказаної ділянки дороги та продовжувати вживати їх аж до усунення правопорушення та забезпечення безпечних умов дорожнього руху.</li>
