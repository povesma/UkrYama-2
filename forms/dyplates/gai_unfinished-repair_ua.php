...
<div>
<b><?= $when ?> р.</b> 
мною на території дороги за адресою: <b><?= $where ?></b>  була виявлена ділянка дороги, що знаходиться в стані ремонту,
...
<li>Вжити заходів для забезпечення безпечного експлуатаційного стану вказаної дороги (обмежити або заборонити рух, 
